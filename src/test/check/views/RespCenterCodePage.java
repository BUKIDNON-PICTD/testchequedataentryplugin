...
public class RespCenterCodePage extends javax.swing.JPanel {

    /**
     * Creates new form HousingLedgerPage
     */
    public RespCenterCodePage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xTextField2.setCaption("Resp Center Name");
        xTextField2.setName("entity.respcentercodename"); // NOI18N
        xTextField2.setPreferredSize(new java.awt.Dimension(0, 20));
        xFormPanel1.add(xTextField2);

        xTextField3.setCaption("Resp Center Code");
        xTextField3.setName("entity.respcentercode"); // NOI18N
        ...
        xTabbedPane1.addTab("RespCenter Code Capture", xPanel1);
